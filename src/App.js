            ...
            <div className="App">
                ...
                <div className="section">
                    ...
                    <p>The visualization below shows a map of the US, with 'clouds' of lead over each state. The size and darkness of the clouds is relative to 
                        the log10 of how many grams of lead were purchased (in the form of gasoline) for motor vehicles (M and B for M/Billion grams, respectively). 
                        Our formula is use log10(state.year/US.allTimeMin)/log10(US.allTimeMax/US.allTimeMin). We chose this formula, as our values have a great range.
                        Our data takes into account the different limits of grams of lead per gallon of fuel through the years, as well as how much of the purchased 
                        gasoline was leaded vs. unleaded. You can click and drag the bar below the graph to see how the clouds grow and shrink through the years.
                        Notice how drastically lead emissions decrease after 1975.</p>
                </div>
                <PollutionCloudMap/>
                <div className="section">
